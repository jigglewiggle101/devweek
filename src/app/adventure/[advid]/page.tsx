...
export default function Adventure(props: {params: {advid: Id<"newadv">};
 }) {
  const handplayAction = useAction(api.chat.handlePlayerAction);
  const advid = props.params.advid;
                    ...
                    {item && item.imageUrl ? (
                      <div className="flex flex-col text-center text-xl">
                        <img
                          ...
                          src={
                            items?.find((item) => item.itemName === itemName)?.imageUrl
                          }
                        />
                        {itemName}
                      </div>
